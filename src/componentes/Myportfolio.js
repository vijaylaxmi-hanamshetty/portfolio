...
export default function MyPortfolio() {
  return (
    <section className="py-16 bg-gray-100" id="MyPortfolio">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-sm text-blue-500 uppercase mb-2">Recent Projects</p>
          <h2 className="text-3xl font-bold text-gray-800">My Portfolio</h2>
        </div>
        <div className="flex justify-center mb-8">
          <button className="flex items-center space-x-2 bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-700 transition duration-300">
            <svg
